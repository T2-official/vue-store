          ...
          <div class="ng-promise-box">
            <div class="ng-promise">
              <p class="text">
                ...
                <a class="icon1" href="javascript:;">满99元全场免邮</a>
                <a class="icon1" href="javascript:;" style="margin-right: 0">100%品质保证</a>
              </p>
            </div>
          </div>
          <div class="github">
            <a href="https://github.com/T2-official" target="_blank">
...
export default {
  ...
  data() {
    return {
      activeIndex: "", // which router
      search: "", // search keyword
      register: false, // register component is visible
      visible: false // account is loggin
    };
  },
  created() {
    // access localStorage in browser to see whether is logging in
